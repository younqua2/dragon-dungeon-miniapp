export const itemData = {
	...
	lifeOrb: {
		...
		description: [
			...
			"공격은 더 이상 하트를 회복하지 않습니다. 장착자는 피해 +50% 및 재충전 시간 -50%를 얻습니다. 하트를 회복하는 권속만 장착할 수 있습니다.",
	...
	twistedSpoon: {
		...
		description: [
			...
			"이 권속은 제자리에서 텔레포트하는 데 집중하지만, 그 대가로 누적 피해가 75% 감소한다. 이 아이템은 캐이시, 윤겔라 또는 후딘만 지닐 수 있다.",
	...
	heartScale: {
		...
		description: [
			...
			"하트를 회복한 후 이 아이템을 장착한 권속은 웨이브가 끝날 때까지 재충전 속도가 50% 감소합니다.",
	...
	softSand: { 
		...
		description: [
			...
			"가하는 피해가 100% 증가하지만, 적에게 맞을 때마다 절반으로 감소합니다. 범위 권속 전용.",
	...
	stickyBarb: { 
		...
		description: [
			...
			"느려지거나 기절한 적에게 가하는 피해가 25% 증가합니다. 물에서 배치할 수 있는 권속만 해당됩니다.",
	...
	electirizer: { 
		...
		description: [
			...
			"기절한 적에게 30% 추가 피해를 입힌다. 스턴을 일으킬 수 있는 권속만 장착 가능.",
	...
	razorClaw: { 
		...
		description: [
			...
			"치명타는 대상에게 0.2초 동안 둔화를 적용합니다. 상태 이상을 부여하는 권속은 이 아이템을 장착할 수 없습니다.",
	...
	clawFossil: {
		...
		description: [
		    ...
		    "팀에 있는 화석 권속 하나당 피해량이 5% 증가합니다. 아노딥스 또는 아말도가 장착할 수 있습니다.",
	...
	sniperScope: {
		...
		description: [
			...
			'적과의 거리가 150 이상일 경우 피해가 25% 증가하고, 그렇지 않으면 25% 감소한다. 투사체 기반 권속만 사용 가능.',
	...
	hardStone: { 
		...
		description: [
			...
			'가하는 피해가 25% 증가합니다. 화석 권속만 지닐 수 있습니다.',
	...
	domeFossil: {
		...
		description: [
		    ...
		    "팀에 있는 화석 권속 하나당 치명타 확률이 5% 증가합니다. 투구 또는 투구푸스만 장착할 수 있습니다.",
	...
	strangeIdol: {
		...
		description: [
			...
			'데미지가 +50% 증가하며, 저주받은 적 한 마리마다 1%씩 감소한다. 저주 기반 권속만 지닐 수 있다.',
	...
	helixFossil: { 
		...
		description: [
		    ...
		    "팀에 있는 화석 권속 하나당 사거리가 10 증가합니다. 암나이트 또는 암스타만 장착할 수 있습니다.",
	...
	spindaCocktail: { 
		...
		description: [
			...
			'공격자의 사거리가 25% 증가하지만, 대상은 무작위 적이 된다. 단일 대상 권속만 사용 가능.',
	...
	silphScope: {
		...
		description: [
			...
			'보이지 않는 적을 드러낸다. 투사체를 발사하는 권속이 착용해야 한다. 프리스크 특성을 가진 권속은 사거리 +15와 위력 +60을 얻는다.',
	...
	shinyCharm: {
		...
		description: [
		    ...
		    "권속이 색이 다른 이로치가 될 확률이 3배가 됩니다. 루브도가 장착해야 합니다.",
	...
	magmarizer: {
		...
		description: [
		  	...
		  	"화상 상태의 적에게 30% 추가 피해를 입힌다. 화상을 일으킬 수 있는 권속만 장착 가능.",
	...
	litCoal: {
		...
		description: [
			...
			"사용자는 각 공격마다 10% 확률로 화상을 부여합니다. 투사체 기반 권속만 사용 가능합니다.",
	...
	magnet: {
		...
		description: [
			...
			"대상이 방어막을 가지고 있는 동안 공격이 1초 동안 둔화를 겁니다. 투사체 기반 권속만 사용 가능합니다.",
	...
	leftovers: {
		...
		description: [
		    ...
		    "각 투사체가 1% 확률로 하트를 회복합니다. 도탄 권속은 소지할 수 없습니다. (웨이브당 1회 사용)",
	...
	focusBand: {
		...
		description: [
			"Each consecutive attack against the same target increases the damage dealt by 5%. Only usable by projectile-based Pokémon.",
		  	...
		  	"같은 대상에게 공격할 때마다 가하는 피해가 5% 증가합니다.투사체 기반 권속만 사용 가능합니다.",
	...
	alakazite: {
		...
		description: [
			...
			"가지고 있는 권속이 메가진화합니다. 메가진화할 수 있는 권속은 하나뿐입니다.",
